...
export const CONFIDENCE_LABELS = {
  ...
  reported: { label: '보도', color: '#2196f3' },
  speculative: { label: '관측', color: '#ff9800' },
};

// 빌드 시점 기준 시간 생성
const BUILD_TIME = new Date('2026-02-04T15:00:00+09:00');
const h = (hours) => new Date(BUILD_TIME.getTime() - hours * 60 * 60 * 1000).toISOString();
...
export const SAMPLE_EVENTS = [
  {
    ...
    links: [
      { source: '한국경제', url: 'https://www.hankyung.com/example/1', title: '삼성전자, HBM 생산능력 40% 확대', publishedAt: h(2) },
      { source: '조선비즈', url: 'https://biz.chosun.com/example/2', title: '삼성-엔비디아 HBM3E 공급 협상 막바지', publishedAt: h(3) },
    ]
  },
  {
    ...
    links: [
      { source: '연합뉴스', url: 'https://www.yna.co.kr/example/3', title: '삼성전자 4분기 영업익 12.3조', publishedAt: h(26) },
      { source: '매일경제', url: 'https://www.mk.co.kr/example/4', title: '삼성전자 DS부문 2분기 연속 흑자', publishedAt: h(27) },
    ]
  },
  {
    ...
    links: [
      { source: '블룸버그', url: 'https://www.bloomberg.com/example/5', title: 'SK Hynix Secures $12B NVIDIA HBM Deal', publishedAt: h(4) },
      { source: '서울경제', url: 'https://www.sedaily.com/example/6', title: 'SK하이닉스-엔비디아 15조 계약', publishedAt: h(5) },
    ]
  },
  {
    ...
    links: [
      { source: 'Reuters', url: 'https://www.reuters.com/example/7', title: 'Tesla Recalls 120,000 Cybertrucks', publishedAt: h(6) },
      { source: 'CNBC', url: 'https://www.cnbc.com/example/8', title: 'Tesla Cybertruck Recall: What You Need to Know', publishedAt: h(7) },
    ]
  },
  {
    ...
    links: [
      { source: 'Bloomberg', url: 'https://www.bloomberg.com/example/9', title: 'Tesla Q4 Deliveries Beat Estimates', publishedAt: h(30) },
    ]
  },
  {
    ...
    links: [
      { source: 'CNBC', url: 'https://www.cnbc.com/example/10', title: 'NVIDIA Blackwell Mass Production Begins', publishedAt: h(8) },
      { source: 'WSJ', url: 'https://www.wsj.com/example/11', title: 'Big Tech Races to Secure NVIDIA GPUs', publishedAt: h(10) },
    ]
  },
  {
    ...
    links: [
      { source: 'Apple Insider', url: 'https://appleinsider.com/example/12', title: 'iPhone 17 Pro to Feature Apple AI Chip', publishedAt: h(36) },
    ]
  },
  {
    ...
    links: [
      { source: '한국경제', url: 'https://www.hankyung.com/example/13', title: '현대차 조지아공장 증설 확정', publishedAt: h(5) },
    ]
  },
  {
    ...
    links: [
      { source: '조선비즈', url: 'https://biz.chosun.com/example/14', title: '네이버 AI 검색 큐: 2천만 사용자 돌파', publishedAt: h(3) },
    ]
  },
  {
    ...
    links: [
      { source: 'TechCrunch', url: 'https://techcrunch.com/example/15', title: 'Threads Hits 500M Users', publishedAt: h(28) },
    ]
  },
  {
    ...
    links: [
      { source: '매일경제', url: 'https://www.mk.co.kr/example/16', title: 'KB금융 배당금 4,800원 확정', publishedAt: h(4) },
    ]
  },
  {
    ...
    links: [
      { source: 'Bloomberg', url: 'https://www.bloomberg.com/example/17', title: 'JPMorgan Sees 3 Fed Rate Cuts in 2026', publishedAt: h(32) },
    ]
  },
  {
    ...
    links: [
      { source: '뉴스1', url: 'https://www.news1.kr/example/18', title: '셀트리온 FDA 승인 획득', publishedAt: h(6) },
    ]
  },
  {
    ...
    links: [
      { source: 'Reuters', url: 'https://www.reuters.com/example/19', title: 'Google Loses Antitrust Case', publishedAt: h(10) },
    ]
  },
];
...
export function getEventsByPeriod(events, hours) {
  const cutoff = new Date(BUILD_TIME.getTime() - hours * 60 * 60 * 1000);
  return events.filter(e => new Date(e.startedAt) > cutoff);
}

export function getTopEvents(hours = 24, limit = 10) {
  const cutoff = new Date(BUILD_TIME.getTime() - hours * 60 * 60 * 1000);
...
export function countEventsByLabel(events) {
  const counts = {};
